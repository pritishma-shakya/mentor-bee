...
export default function RewardsPage() {
  ...
  const badgeThresholds: Badge[] = [
    ...
    { name: "Fast Learner", icon: Zap, points: 3000, color: "text-red-600", bg: "bg-red-100", border: "border-red-200" },
  ...
  const paginatedData = (recentActivities || []).slice((currentPage - 1) * ITEMS_PER_PAGE, currentPage * ITEMS_PER_PAGE);
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-xl p-6 shadow-md border border-gray-100 hover:shadow-lg transition">
              ...
              <div className="mt-6">
                <div className="flex justify-between items-center mb-4">
                  <h3 className="text-lg font-semibold text-gray-800">Badge Journey</h3>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-indigo-50 to-white rounded-xl p-5 shadow-md border border-indigo-100 hover:shadow-lg transition">
              <h3 className="text-lg font-semibold text-gray-800 mb-3">How to Earn Points</h3>
