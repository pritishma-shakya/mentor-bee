    ...
    const verify = async () => {
      try {
        ...
        if (res.ok && data.success) {
          ...
          if (data.role === "mentor") {
            setMessage(
              "Email verified successfully! Redirecting to mentor setup..."
            );
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden p-10 text-center">
        ...
        <div className="flex flex-col items-center">
          ...
          {redirectPath === "/setup" ? (
            ...
            <a
              href="/login"
              className="px-6 py-3 w-full bg-orange-600 hover:bg-orange-700 text-white rounded-lg font-bold transition"
              onClick={() => {
        ...
        {status === "error" && (
          <div className="flex flex-col items-center">
            ...
            <a
              href="/login"
              className="px-6 py-3 w-full bg-gray-200 hover:bg-gray-300 text-gray-800 rounded-lg font-bold transition"
            >
              Return to Login
            </a>
          </div>
